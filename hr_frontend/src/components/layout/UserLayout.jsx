...
import { Home, User, Clock, Calendar, Award, DollarSign, Receipt, Menu, X, LogOut } from 'lucide-react';
            ...
            <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
              <div className="flex items-center w-full">
                <div className="ml-3 flex-1">
                  ...
                  <p className="text-xs font-medium text-gray-500">직원</p>
                </div>
                <button
